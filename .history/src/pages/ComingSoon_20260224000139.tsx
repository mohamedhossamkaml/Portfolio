...
const ComingSoon: React.FC<{ title?: string; launchDate?: string }> = ({ title, launchDate = "2026-06-01" }) => {
  const { t } = useLanguage();
      ...
      >
        ...
        <div className="flex justify-center gap-6 mb-8">
          {["days", "hours", "minutes", "seconds"].map((unit, i) => (
            <div key={i} className="flex flex-col items-center bg-gradient-to-br from-teal-500 to-teal-700
