  ...
  return (
    <AnimatePresence>
      {showHero && (
        ...
        >
          {/* 🌊 */}
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-deepMint-400 to-deepMint-600 rounded-full opacity-20 blur-3xl animate-pulse  bg-black/10 -z-10" />
