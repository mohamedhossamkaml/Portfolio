...
function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-20 px-6 bg-my-Body  text-deepMint-50 overflow-hidden md:bg-[url('https://i.postimg.cc/W1YZxTpJ/about-img.jpg')] md:bg-no-repeat md:bg-right "
    >
      {/* 🌊 */}
      ...
      {/* 🟣 Social Media */}
      <motion.div  {...fadeLeft} className="max-w-6xl mx-auto mb-12 flex  ">
        <span className="font-semibold mr-6 mb-2">Follow Me</span>
        <FontAwesomeIcon icon={icons.facebook} className=" transition" />
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4">
            ...
            <span className="text-deepMint-500 dark:text-softDark">
              <Typewriter
                words={["Frontend Developer", "UI/UX Enthusiast"]}
                loop={true}
                cursor
                cursorStyle="|"
                typeSpeed={70}
          ...
          <motion.div  {...fadeLeft} className="flex gap-4">
            <a
              href="#about"
