...
function WorkCard({ work, onDemoClick }) {
  return (
    <motion.div {...zoomIn} className="bg-deepMint-100 dark:bg-deepMint-800 rounded-lg shadow hover:shadow-lg overflow-hidden transition">
      ...
      <motion.div {...fadeLeft} className="p-4">
        ...
        >
          Demo <FontAwesomeIcon icon={icons.arrow} className="text-sm" />
        </button>
      </motion.div>
    </motion.div>
  );
