    ...
    <AnimatePresence>
      {showHero && (
        ...
        >
          ...
          {/* 🟡 Communication Cards */}
          <motion.div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-deepMint-400 to-deepMint-600 rounded-full opacity-20 blur-3xl animate-pulse -z-10" />
