...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* 🟡 Communication Cards */}
      <div className=" mt-20 grid md:grid-cols-3 gap-1 text-left">
        {
          icons2.map((item, i) => (
            <motion.div key={i} {...zoomIn} className="flex overflow-visible items-start gap-4 p-5 rounded-md shadow-md cursor-pointer ">
              <div className={`w-1 h-12 flex items-center justify-center rounded-full ${item.bg} ${item.text}`}>
