    ...
    <AnimatePresence>
      {showHero && (
        <motion.section
          ...
          id="home"
          className="relative py-20 px-6 right-2 bg-my-Body  text-deepMint-50 overflow-hidden md:bg-[url('/public/my-photo.png')]  bg-black/10 md:bg-no-repeat md:bg-right "
        >
          {/* 🌊 */}
