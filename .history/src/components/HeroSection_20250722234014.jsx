      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="flex gap-4 text-xl text-deepMint-500">
            ...
            <a href="https://instagram.com" target="_blank" rel="noreferrer"><i className="uil uil-instagram"></i></a>
            <a href="https://x.com" target="_blank" rel="noreferrer"><i className="uil uil-twitter"></i></a>
          </div>
        </div>
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold">Hi, I'm Mariam</h1>
