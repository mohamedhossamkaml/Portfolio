...
function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-20 px-6 bg-my-Body  text-deepMint-800 dark:text-deepMint-50 overflow-hidden md:bg-[url('https://i.postimg.cc/W1YZxTpJ/about-img.jpg')] md:bg-no-repeat md:bg-left md:bg-contain"
    >
      {/* 🌊 */}
      ...
      {/* 🟡 Communication Cards */}
      <div className=" mt-20 grid md:grid-cols-3 gap-5 max-w-dvh bg-white text-left">
        {
          icons2.map((item, i) => (
            <motion.div key={i} {...zoomIn} className="flex  overflow-visible items-start gap-2 p-5 rounded-md  shadow-md cursor-pointer ">
