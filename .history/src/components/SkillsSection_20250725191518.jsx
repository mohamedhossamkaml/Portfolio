        ...
        <motion.div {...fadeLeft} className="space-y-4">
          {Object.entries(iconMap).map(([key, Icon]) => (
            <motion.div
              ...
              className={`flex items-center justify-between p-4 rounded-lg bg-deepMint-100   cursor-pointer shadow-md transition duration-300 ${activeTab === key
                ? "bg-deepMint-500 dark:bg-deepMint-50" : "hover:bg-deepMint-50 dark:hover:bg-deepMint-600"
                }`}
            >
              <div className="flex items-center text-deepMint-800 dark:text-deepMint-50 dark:bg-deepMint-700  gap-4">
