function AboutSection() {
  return (
    <section id="about" className="py-16 px-6 bg-white dark:bg-deepMint-800 text-deepMint-800 dark:text-deepMint-50">
      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto items-center">
        ...
        <div>
          <h3 className="text-2xl mb-2">Hi, I'm Mariam Wallas, based in Canada</h3>
          <p className="mb-6">
