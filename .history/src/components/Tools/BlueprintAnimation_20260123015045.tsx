...
skills.forEach(skill => {
  ...
  return (
    <div className="relative w-full h-full min-h-[400px] flex items-center justify-center p-4">
      {/* ستايل مخصص لتلوين الأكواد */}
      <style>
        {`
          .keyword { color: #569CD6; }   /* أزرق للكلمات المفتاحية */
          .variable { color: #9CDCFE; }  /* سماوي للمتغيرات */
          .string { color: #CE9178; }    /* برتقالي للنصوص */
          .function { color: #DCDCAA; }  /* أصفر للدوال */
          .class { color: #4EC9B0; }     /* أخضر للكلاسات */
        `}
      </style>
      ...
      >
        ...
        <foreignObject x="0" y="50" width="600" height="330">
          <div className="flex w-full h-full">
            ...
            {/* منطقة الكود */}
            <div className="pl-4 w-full text-[15px] leading-[26px] text-white">
              <Typewriter
                words={codeBlocks}
                loop={true}
                cursor
