...
class Developer {
  public function build() {
    ...
    `function greet(name) { console.log("Hello, " + name); } greet("Mohamed Hossam");`,
    `const skills = ["Laravel", "React", "Node.js"]; skills.forEach(skill => { console.log("Expert in " + skill); });`,
    `class Developer { constructor(name) { this.name = name; } introduce() { return "Hi, I'm " + this.name + " and I build web apps!"; } } const dev = new Developer("Mohamed Hossam"); console.log(dev.introduce());`,
