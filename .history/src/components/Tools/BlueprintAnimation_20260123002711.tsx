...
const CodeEditorAnimation = () => {
  ...
  const codeSnippet = [
    ...
    "console.log('My name is Mohamed hossam!');",
    "console.log('I am a FullStack Web Developer!');",
    "console.log('I have high level experience in web design, development knowledge and producing quality work!');"
  ];
