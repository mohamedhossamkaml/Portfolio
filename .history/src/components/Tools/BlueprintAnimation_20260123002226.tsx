...
const CodeEditorAnimation = () => {
  ...
  return (
    ...
    >
      ...
      {/* أسطر الكود مع Typewriter */}
      <foreignObject x="20" y="50" width="560" height="300">
        <div className="font-mono text-sm text-teal-400 dark:text-teal-300">
          <Typewriter
            words={codeLines}
            ...
            delaySpeed={1500}    // وقت الانتظار قبل المسح
          />
        </div>
      </foreignObject>
