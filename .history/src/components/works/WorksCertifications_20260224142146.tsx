...
const WorksCertifications: React.FC = () => {
  ...
  const certColors = [
    ...
    { base: 'text-violet-500 dark:text-violet-400', hover: 'group-hover:text-violet-200', glow: 'group-hover:drop-shadow-[0_0_18px_rgba(139,92,246,1)]' },
    { base: 'text-pink-500 dark:text-pink-400', hover: 'group-hover:text-pink-200', glow: 'group-hover:drop-shadow-[0_0_18px_rgba(236,72,153,1)]' },
    { base: 'text-green-500 dark:text-green-400', hover: 'group-hover:text-green-200', glow: 'group-hover:drop-shadow-[0_0_18px_rgba(34,197,94,1)]' },
  ];
          ...
          {certificationsFromT.map((cert: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                whileTap={{ scale: 0.96 }}
                className="group bg-white  dark:hover:shadow-teal-900 dark:bg-gray-900 p-8 rounded-2xl shadow-lg text-center transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 relative overflow-hidden"
              >
