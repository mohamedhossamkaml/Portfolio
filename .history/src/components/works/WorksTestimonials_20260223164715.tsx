        ...
        >
          {testimonialsFromT.map((testimonial: any, index: number) => (
            <motion.div
              ...
              whileTap={{ scale: 0.97 }}
              className="group bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 relative overflow-hidden"
            >
              {/* Decorative overlay */}
              ...
              <div className="relative">
                <div className="flex gap-1 mb-6  dark:hover:shadow-teal-900 justify-center">
