...
// const iconComponents = [UilAward, UilSuitcaseAlt, UilHeadphonesAlt];
...
function AboutSection() {
  ...
  return (
    <motion.section
      {...fadeUp}
      id="about"
      className="py-16 px-6 bg-white dark:bg-deepMint-800 text-deepMint-800 dark:text-deepMint-50"
    >
      <h2 className="text-4xl font-bold text-center mb-12">About me</h2>
