...
function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-20 px-6 bg-white dark:bg-deepMint-800 text-deepMint-800 dark:text-deepMint-50 overflow-hidden md:bg-[url('https://i.postimg.cc/W1YZxTpJ/about-img.jpg')] md:bg-no-repeat md:bg-right md:bg-contain"
    // style={{
    //   backgroundImage:
    //     "url('https://i.postimg.cc/W1YZxTpJ/about-img.jpg')",
