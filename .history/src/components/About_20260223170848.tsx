...
import { SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiLaravel } from 'react-icons/si';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeIn} initial="hidden" whileInView="visible" className="max-w-3xl mx-auto text-center mb-16">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br shadow-[0_4px_20px_rgba(0,0,0,0.1)]
                      hover:shadow-[0_8px_30px_rgba(20,184,166,0.3)]
                      transition-shadow duration-300 ease-in-out
                      overflow-hidden from-teal-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 "
          >
            <BlueprintAnimation />
          </motion.div>
        </motion.div>
