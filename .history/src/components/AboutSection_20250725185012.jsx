    ...
    >
      ...
      >
        ...
        <motion.div {...fadeLeft}>
          ...
          <motion.div
            {...fadeRight}
            className="grid grid-cols-1 sm:grid-cols-3 text-deepMint-800  gap-4 mb-6"
          >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-4 py-2 bg-deepMint-500 text-deepMoint-400 rounded hover:bg-deepMint-600 transition-all duration-300"
          >
            <UilNavigator />
            Contact me
          </a>
