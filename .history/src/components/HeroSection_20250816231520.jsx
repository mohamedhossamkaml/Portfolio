    ...
    <AnimatePresence>
      {showHero && (
        ...
        >
          ...
          {/* 🟡 Communication Cards */}
          <motion.div className="absolute top-10 left-10 hidden md:block"></motion.div>
          {icons2.map((item, i) => (
            <motion.div key={i} {...zoomIn} className="flex items-start gap-2 p-5 rounded-md mb-4 cursor-pointer">
