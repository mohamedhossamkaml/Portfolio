    ...
    >
      ...
      <div className="mt-20 grid md:grid-cols-3 gap-6 text-left">
        {[
          ...
          >
            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-deepMint-200 dark:bg-accentDark/30 text-deepMint-700 dark:text-softDark shadow-sm">
