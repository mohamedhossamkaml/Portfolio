        ...
        >
          {servicesWithIcons.map((service, index) => (
            <motion.div
              key={index}
              variants={scaleIn}
              className="group bg-white dark:bg-teal-800 dark:hover:shadow-teal-900 rounded-xl shadow-lg transition-all overflow-hidden border border-gray-100 dark:border-gray-700
