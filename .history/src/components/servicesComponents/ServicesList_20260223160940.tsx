...
import { Code2, Plug, Palette, Hammer, PaintBucket, Wrench } from 'lucide-react';
import { useLanguage } from '../../context/LanguageContext';

const serviceIcons = [Code2, Plug, Palette, Hammer, PaintBucket, Wrench];
const serviceColors = [
        ...
        >
          {servicesWithIcons.map((service, index) => (
            <motion.div
              key={index}
              variants={scaleIn}
              className="group bg-white dark:bg-gray-800 dark:hover:shadow-teal-900 rounded-xl shadow-lg transition-all overflow-hidden border border-gray-100 dark:border-gray-700
