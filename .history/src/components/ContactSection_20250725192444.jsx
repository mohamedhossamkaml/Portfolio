...
function ContactSection() {
  return (
    <motion.section {...fadeUp} {...zoomIn} id="contact" className="py-16 px-6 bg-deepMint-400 dark:bg-deepMint-800 text-deepMint-800 dark:text-deepMint-50">
      <h2 className="text-4xl font-bold text-center mb-8 text-deepMint-100">Get In Touch</h2>
