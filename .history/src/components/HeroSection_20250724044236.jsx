...
function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-20 px-6 bg-my-Body  text-deepMint-800 dark:text-deepMint-50 overflow-hidden md:bg-[url('https://i.postimg.cc/W1YZxTpJ/about-img.jpg')] md:bg-no-repeat md:bg-right "
    >
      {/* 🌊 */}
      ...
      {/* 🟡 Communication Cards */}
      <div className=" mt-20 md:hidden flex gap-5 text-left">
        {
          icons2.map((item, i) => (
            <motion.div key={i} {...zoomIn} className="flex items-start gap-2 p-5 rounded-md  shadow-md cursor-pointer ">
