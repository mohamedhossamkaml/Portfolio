...
const techLogos = [
  ...
  { node: <SiNodedotjs className="text-green-500 group-hover:text-green-300 transition-colors duration-500" />, title: "Node.js", href: "https://nodejs.org" },
  { node: <SiExpress className="text-gray-700 group-hover:text-gray-500 transition-colors duration-500" />, title: "Express.js", href: "https://expressjs.com" },
  { node: <SiDjango className="text-green-700 group-hover:text-green-400 transition-colors duration-500" />, title: "Django", href: "https://www.djangoproject.com" },
  ...
  { node: <SiMysql className="text-blue-700 group-hover:text-blue-400 transition-colors duration-500" />, title: "MySQL", href: "https://www.mysql.com" },
  { node: <SiPostgresql className="text-blue-600 group-hover:text-blue-400 transition-colors duration-500" />, title: "PostgreSQL", href: "https://www.postgresql.org" },
  { node: <SiRedis className="text-red-600 group-hover:text-red-400 transition-colors duration-500" />, title: "Redis", href: "https://redis.io" },
  { node: <SiVercel className="text-black dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-500" />, title: "Vercel", href: "https://vercel.com" },
  { node: <SiMongodb className="text-green-600 group-hover:text-green-400 transition-colors duration-500" />, title: "MongoDB", href: "https://www.mongodb.com" },
];
