...
const CodeRainBackground = ({
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-cyan-400/30 via-cyan-600/50  to-cyan-800/90 dark:from-slate-700/50 dark:via-slate-800/60 dark:to-slate-950/90"></div>
    </div>
  );
};
