...
const CodeRainBackground = ({
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b  from-teal-700/60 via-teal-800/60 to-teal-950/90 dark:from-slate-700/60 dark:via-slate-800/60 dark:to-slate-950/90"></div>
    </div>
  );
};
