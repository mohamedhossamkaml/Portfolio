...
const CodeRainBackground = ({
  fontSize = 14,
  speed = 120, // كل ما تزود الرقم الحركة تبقى أبطأ
  density = 0.6, // كثافة الأكواد (من 0.2 خفيف لحد 1 كثيف)
  colors = {
  ...
  }, [fontSize, speed, density, colors]);

  return (
    <div className="absolute inset-0 z-0 pointer-events-none bg-black/65">
