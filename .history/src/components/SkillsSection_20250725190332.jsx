        ...
        <motion.div {...fadeLeft} className="space-y-4">
          {Object.entries(iconMap).map(([key, Icon]) => (
            <motion.div
              ...
              className={`flex items-center justify-between p-4 rounded-lg bg-deepMint-100 dark:bg-deepMint-700 dark:text-deepMint-50  cursor-pointer shadow-md transition duration-300 ${activeTab === key
