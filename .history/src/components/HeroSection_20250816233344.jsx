  ...
  return (
    <AnimatePresence>
      {showHero && (
        ...
        >
          {/* 🟡 Communication Cards */}
          <motion.div className="absolute top-0  right-0 w-[500px] h-[500px] bg-gradient-to-br md:bg-[url('/public/my-photo.png')] md:bg-no-repeat md:bg-right rounded-full opacity-75  z-20 " />
          {/* 🟡 Background Circle */}
          <motion.div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-deepMint-500 to-deepMint-800 rounded-full opacity-20 " />
