...
function Navbar({ toggleSidebar }) {
  ...
  return (
    <header data-aos="fade-down" className={`fixed top-0 left-0 w-full z-50 transition-colors duration-300
      ${scrolled
...
//         ${scrolled
//           ? "bg-baseLight/80 dark:bg-baseDark/80 backdrop-blur-md shadow-lg py-2"
//           : "bg-baseLight dark:bg-baseDark shadow-md py-4"
//         }`}
//     >
//       <nav className="container mx-auto flex items-center justify-between px-6 dark:text-textDark text-textLight">
//         {/* Logo */}
//         <motion.a
//           href="#home"
//           initial={{ x: -40, opacity: 0 }}
//           animate={{ x: 0, opacity: 1 }}
//           transition={{ type: "spring", stiffness: 200 }}
//           className="text-2xl font-bold text-accent dark:text-softDark"
//         >
//           Mohamed Hossam
//         </motion.a>
...
//             transition={{ duration: 0.3 }}
//             className="text-xl text-accentDark dark:text-softDark"
//             title={isDark ? "Light Mode" : "Dark Mode"}
//           >
//             <FontAwesomeIcon icon={isDark ? icons.sun : icons.moon} />
//           </motion.button>
