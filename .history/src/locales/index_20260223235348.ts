...
import * as enComingSoon from "./en/comingSoon";
...
import * as arComingSoon from "./ar/comingSoon";
...
export const translations = {
  en: {
    ...
    servicesPage:
      (enServicesPage as any).default || enServicesPage.servicesPage,
    ...
    comingSoon: (enComingSoon as any).default || enComingSoon.comingSoon,
  },
  ar: {
    ...
    servicesPage:
      (arServicesPage as any).default || arServicesPage.servicesPage,
    ...
    comingSoon: (arComingSoon as any).default || arComingSoon.comingSoon,
  },
} as const;
